...
const hike = HIKES.find(h => h.slug === "c-level-cirque");

export default function CLevelCirquePage() {
    ...
    <main className="hikeDetailPage">
      ...
      <section className="hikeDetailFlex">
        ...
        <div className="hikeDetailWriteup">
          ...
          <p>
            C-Level Cirque is a moderate hike with rewarding views and a unique cirque formation. The trail is a steady climb through forest and old mining relics, ending at a dramatic bowl beneath Cascade Mountain. Bring water and enjoy the peaceful setting!
          </p>
        </div>
      </section>
    </main>
